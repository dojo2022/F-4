...
<body>
    ...
    <div id='app'>
        ...
        <v-date-picker v-model='selectedDate' :popover="popover" v-model="date" @dayclick="onDayClick">
...
?
    <div>
    時間指定
    <input type="checkbox" id="timeCheckOnOff" class="timeCheck" onclick="timeOnOff();">
    </div>
    <input type="time" name="example" id="timeInput"></p>
    <input type="text" value="" placeholder="タスク入力" ></p>
